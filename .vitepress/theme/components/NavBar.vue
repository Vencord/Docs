...
<template>
    <nav>
        <div class="nav-content">
            <div id="logo">
                <a href="https://vencord.dev/" id="title">
                    <img
                        src="https://vencord.dev/assets/logo-nav-oneko-padding.png"
                        alt="Vencord Home"
                    />
            ...
            <div id="btns" class="p-label-m">
                <ul id="right">
                    <li v-for="(link, url) in navLinks" :key="url">
                        <a :href="`/${url}`">{{ link[0] }}</a>
                    </li>
                    <li>
                        <a
                            href="https://docs.vencord.dev"
                            style="--accent: var(--accentRed)"
                            class="active"
                            >Docs</a
                        >
                    </li>
