...
Now to the `component`. You can either build a component directly in it or import it from another file. In this guide we create the component in another file and import it later on.
...
Now build your code with `pnpm build` (or `pnpm watch`) and then inject it `pnpm inject`.
